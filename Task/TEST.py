...
def FindElement(link):
    ...
    try:
        ...
        brow.get(link)
        brow.find_element(By.CSS_SELECTOR, '.first_block .first').send_keys('Kesa')
        brow.find_element(By.CSS_SELECTOR, '.first_block .second').send_keys('Lisa')
        brow.find_element(By.CSS_SELECTOR, '.third_class .third').send_keys('KL@google.com')
